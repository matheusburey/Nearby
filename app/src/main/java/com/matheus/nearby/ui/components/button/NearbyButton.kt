package com.matheus.nearby.ui.components.button
...
fun NearbyButton(
    ...
    Button(
        ...
        Row(
            ...
            iconRes?.let {
                Icon(
                    painter = painterResource(id = iconRes), contentDescription = "button icon"
                )
            }
...
private fun NearbyButtonNoIconPreview() {
    NearbyButton(
        modifier = Modifier.fillMaxWidth(), text = "Confirm", iconRes = null
    ) {}
}
